...
public class BiometricPromptApi28 implements IBiometricPromptImpl {
    private static final String KEY_NAME = "BiometricApi28";
    ...
    public void authenticate(@Nullable CancellationSignal cancel,
        ...
        */
        //包含人脸识别等一系列生物识别
        mBiometricPrompt.authenticate(mCancellationSignal, mActivity.getMainExecutor(),new BiometricPromptCallbackImpl() );
    }
